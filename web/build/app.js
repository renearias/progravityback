...
angular.module('app.contratos')
        .controller('CambiarEquipoWizardCtrl', function($scope,$http,$modal,equipos){
        ...
        $scope.urlContrato=function(){
                return Routing.generate('imprimir_contrato',{cedula:$scope.cliente.uid})
            };
        $scope.imprimirContrato = function (elem) {
         ...
         $scope.urlInstalacion=function(){
                return Routing.generate('imprimir_instalacion',{cedula:$scope.cliente.uid})
            };
        $scope.imprimirInstalacion = function (elem) {
         ...
         $scope.urlAnexo=function(){
                //return Routing.generate('imprimir_anexo_cambio_plan',{cedula:$scope.cliente.uid})
            };
...
angular.module('app.contratos').directive('contratoWizard', function () {
    return {
        restrict: 'A',
        scope: {
            'contratoWizardCallback': '&',
            'contratoCliente': '='
        },
        link: function (scope, element, attributes) {
